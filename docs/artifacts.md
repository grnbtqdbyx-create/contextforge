...
| `contextforge-publish-readiness.md` | Release maintainers | you need npm metadata, Trusted Publishing, and human approval readiness in one file | `contextforge publish-readiness --summary contextforge-publish-readiness.md` |
