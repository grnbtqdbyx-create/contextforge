...
| `instruction-file` | file is a repo-level agent instruction file such as `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.github/copilot-instructions.md`, `.github/instructions/**/*.instructions.md`, `.github/prompts/**/*.prompt.md`, `.github/agents/**/*.md`, `.github/agents/**/*.agent.md`, `.claude/agents/**/*.md`, `.claude/commands/**/*.md`, project `SKILL.md` files, `.cursor/rules/**/*.mdc`, `.cursorrules`, `.clinerules/**/*.{md,txt}`, `.clinerules`, `.windsurfrules`, or `.windsurf/rules/**/*.{md,mdc,txt}` |
