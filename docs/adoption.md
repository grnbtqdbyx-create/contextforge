...
| promptfoo / eval suites | prompt and model behavior tests | repository readiness before agents ingest docs, rules, PR comments, or MCP configs |
...
- The repository dogfoods its own GitHub Action and uploads scorecard, MCP audit, MCP SARIF, Claude settings audit, proof-pack, review-kit, artifact-map, SARIF, JSON, HTML, and Markdown artifacts.
