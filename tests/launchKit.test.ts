...
describe('launch kit report', () => {
  it('creates a shareable build-in-public launch kit for agent-ready repos', () => {
    ...
    expect(kit).toContain('contextforge launch-snapshot --output docs/launch-snapshot.md');
    ...
    expect(kit).toContain('contextforge workflow-audit --summary contextforge-workflow-audit.md --sarif contextforge-workflow.sarif');
    expect(kit).toContain('contextforge trace-audit --demo --summary contextforge-trace-audit.md');
    expect(kit).toContain('contextforge cost-estimate --demo --summary contextforge-cost-estimate.md');
