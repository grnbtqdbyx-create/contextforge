...
describe('package metadata', () => {
  it('uses npm-normalized bin metadata for the contextforge CLI', async () => {
    ...
    expect(pkg.files).toContain('contextforge-agent-surface-map.md');
    expect(pkg.files).toContain('contextforge-agent-surface-inventory.md');
    ...
    expect(pkg.files).toContain('contextforge-actions-audit.md');
